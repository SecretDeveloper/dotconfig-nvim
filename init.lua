...
vim.keymap.set("i", "jj", "<Esc>", { desc = "When in Insert mode 'jj' will work as Esc." })
...
require("lazy").setup(
	{
		...
		},
		{
			...
			config = function()
				...
				---@diagnostic disable-next-line: missing-fields -- needed due to weird missing field warning
